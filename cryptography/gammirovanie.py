...
@author: Maksim 
"""# при длине алфавита 64+ слов символы 65... не расшифровываются
...
def Gamma(A,C, T1, M, lenth):
    ...
    return T1
def Encryption(arr_for_crypt, alphab, arr_of_gamma):
    res=''
...
Gamma(A,C,T, M, lenth)
print('Gamma:',T)
encrypted = Encryption(inf_for_crypt, start_alphab, T)
decrypted = Decryption(encrypted, start_alphab, T)
